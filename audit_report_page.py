...
from track import Track, ComputerScience, DataScience, IntelligentSystems, Systems, Traditional, InteractiveComputing, CyberSecurity, SoftwareEngineering, Network
...
class AuditReportPage(ttk.Frame):
    ...
    def generate_report_content(self, audit_report_filepath):
        ...
        self.core_gpa = audit_report.get_core_gpa_section()
        self.elective_gpa = audit_report.get_elective_gpa_section()
        self.overall_gpa = audit_report.get_combined_gpa_section()
        print(audit_report.get_gpas_section())
        print(audit_report.get_courses_section())
        print(audit_report.get_outstanding_requirements_section())
