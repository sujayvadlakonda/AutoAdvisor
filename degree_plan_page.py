...
class DegreePlanPage(ttk.Frame):
    def __init__(self, container, controller):
        ...
        # Create Canvas
        dp_canvas = Canvas(main_frame, bg="black")
        ...
        # Create Degree Plan Frame
        frame = ttk.Frame(dp_canvas, style="dp_gui.TFrame")
        frame.pack(side=LEFT, fill=BOTH, expand=1)
        dp_canvas.create_window((0,0), window=frame, anchor="nw") 

        # for thing in range(100):
        #     Button(frame, text=f'Button {thing} Yo').grid(row=thing, column=0, pady=10, padx=10)
...
# 0. Gui Title Frame
        ...
        fr_titleGui.grid(column=0, row=0, sticky="nsew", padx=100, pady=10, columnspan=2)
